...
public class CsvReader{
    ...
    private void checkFileExtension() {
        boolean ans;
        String fileName = Data.getInputFilePath();
        try {
    ...
    private void setUrls() {
        Data.setLeetcodeUrl("https://leetcode.com/");
        Data.setCodechefUrl("https://www.codechef.com/users/");
        Data.setCodeforcesUrl("https://codeforces.com/profile/");
        Data.setGeekforgeeksUrl("https://auth.geeksforgeeks.org/user/");
    }
    public void startCsvreader() {
        String FilePath = "";
        try {
            setUrls();
            FilePath = Data.getInputFilePath();
            checkFileExtension();
